...
CREATE TABLE "licentia_process_process_atribuido_a" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "process_id" bigint NOT NULL REFERENCES "licentia_process_process" ("id") DEFERRABLE INITIALLY DEFERRED, "user_id" bigint NOT NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED);
CREATE TABLE "licentia_resources_centrodecusto" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "criado_em" datetime NOT NULL, "atualizado_em" datetime NOT NULL, "nome" varchar(100) NOT NULL UNIQUE, "atualizado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED, "criado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE "licentia_resources_componente" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "criado_em" datetime NOT NULL, "atualizado_em" datetime NOT NULL, "nome" varchar(100) NOT NULL UNIQUE, "atualizado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED, "criado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE "licentia_resources_empresa" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "criado_em" datetime NOT NULL, "atualizado_em" datetime NOT NULL, "nome" varchar(100) NOT NULL UNIQUE, "atualizado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED, "criado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE "licentia_resources_limitacaoedicao" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "criado_em" datetime NOT NULL, "atualizado_em" datetime NOT NULL, "nome" varchar(100) NOT NULL UNIQUE, "atualizado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED, "criado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE "licentia_resources_localizacaodorecurso" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "criado_em" datetime NOT NULL, "atualizado_em" datetime NOT NULL, "nome" varchar(100) NOT NULL UNIQUE, "atualizado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED, "criado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE "licentia_resources_statusanaliseautrec" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "criado_em" datetime NOT NULL, "atualizado_em" datetime NOT NULL, "nome" varchar(100) NOT NULL UNIQUE, "atualizado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED, "criado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE "licentia_resources_statusanaliseeditorial" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "criado_em" datetime NOT NULL, "atualizado_em" datetime NOT NULL, "nome" varchar(100) NOT NULL UNIQUE, "atualizado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED, "criado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE "licentia_resources_statusdofreelapagamento" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "criado_em" datetime NOT NULL, "atualizado_em" datetime NOT NULL, "nome" varchar(100) NOT NULL UNIQUE, "atualizado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED, "criado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE "licentia_resources_statusdoorcamento" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "criado_em" datetime NOT NULL, "atualizado_em" datetime NOT NULL, "nome" varchar(100) NOT NULL UNIQUE, "atualizado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED, "criado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE "licentia_resources_statusdoorcamentoaprovacao" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "criado_em" datetime NOT NULL, "atualizado_em" datetime NOT NULL, "nome" varchar(100) NOT NULL UNIQUE, "atualizado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED, "criado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE "licentia_resources_statusdoprocesso" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "criado_em" datetime NOT NULL, "atualizado_em" datetime NOT NULL, "nome" varchar(100) NOT NULL UNIQUE, "atualizado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED, "criado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE "licentia_resources_statusdoprocessopagamentofornecedor" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "criado_em" datetime NOT NULL, "atualizado_em" datetime NOT NULL, "nome" varchar(100) NOT NULL UNIQUE, "atualizado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED, "criado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE "licentia_resources_tipodetermo" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "criado_em" datetime NOT NULL, "atualizado_em" datetime NOT NULL, "nome" varchar(100) NOT NULL UNIQUE, "atualizado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED, "criado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE "users_departamento" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "criado_em" datetime NOT NULL, "atualizado_em" datetime NOT NULL, "nome" varchar(100) NOT NULL UNIQUE, "atualizado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED, "criado_por_id" bigint NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE TABLE "users_user_departamentos" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "user_id" bigint NOT NULL REFERENCES "users_user" ("id") DEFERRABLE INITIALLY DEFERRED, "departamento_id" bigint NOT NULL REFERENCES "users_departamento" ("id") DEFERRABLE INITIALLY DEFERRED);
...
CREATE UNIQUE INDEX "users_user_departamentos_user_id_departamento_id_9b85ac6f_uniq" ON "users_user_departamentos" ("user_id", "departamento_id");
...
CREATE UNIQUE INDEX "licentia_process_process_atribuido_a_process_id_user_id_4a8a82c1_uniq" ON "licentia_process_process_atribuido_a" ("process_id", "user_id");
...
INSERT INTO "sqlite_sequence" VALUES('users_user_groups',10);
INSERT INTO "sqlite_sequence" VALUES('licentia_resources_projeto',3);
INSERT INTO "sqlite_sequence" VALUES('licentia_resources_componente',3);
INSERT INTO "sqlite_sequence" VALUES('licentia_resources_statusdoprocesso',7);
INSERT INTO "sqlite_sequence" VALUES('licentia_resources_tipodetermo',5);
INSERT INTO "sqlite_sequence" VALUES('licentia_resources_statusanaliseautrec',6);
INSERT INTO "sqlite_sequence" VALUES('licentia_resources_statusanaliseeditorial',4);
INSERT INTO "sqlite_sequence" VALUES('licentia_resources_centrodecusto',11);
INSERT INTO "sqlite_sequence" VALUES('licentia_resources_empresa',3);
INSERT INTO "sqlite_sequence" VALUES('licentia_resources_fornecedor',2);
INSERT INTO "sqlite_sequence" VALUES('licentia_resources_limitacaoedicao',3);
INSERT INTO "sqlite_sequence" VALUES('licentia_resources_localizacaodorecurso',5);
INSERT INTO "sqlite_sequence" VALUES('licentia_resources_statusdoorcamentoaprovacao',3);
INSERT INTO "sqlite_sequence" VALUES('licentia_resources_statusdoprocessopagamentofornecedor',2);
INSERT INTO "sqlite_sequence" VALUES('licentia_resources_statusdofreelapagamento',2);
INSERT INTO "sqlite_sequence" VALUES('licentia_resources_statusdoorcamento',3);
INSERT INTO "sqlite_sequence" VALUES('users_departamento',3);
INSERT INTO "sqlite_sequence" VALUES('users_user_departamentos',3);
INSERT INTO "sqlite_sequence" VALUES('licentia_process_historicalprocess',10);
INSERT INTO "sqlite_sequence" VALUES('licentia_process_process',1);
INSERT INTO "sqlite_sequence" VALUES('licentia_process_process_atribuido_a',2);
COMMIT;
